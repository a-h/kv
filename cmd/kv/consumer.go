...
type ConsumerCommand struct {
	...
	Stream ConsumerStreamCommand `cmd:"stream" help:"Continuously consume records from a stream until interrupted."`
	...
	Delete ConsumerDeleteCommand `cmd:"delete" help:"Delete a consumer."`
}
